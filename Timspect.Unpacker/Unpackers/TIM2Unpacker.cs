...
using static Timspect.Core.Formats.TIM2;

namespace Timspect.Unpacker.Unpackers
{
    public static class TIM2Unpacker
    {
        public static void Unpack(string path, string folder, TIM2 file)
        {
            ...
            var xw = XmlWriter.Create(Path.Combine(folder, "_tim2.xml"), xws);
        ...
        public static void Repack(string folder, string outFolder)
        {
            ...
            xml.Load(Path.Combine(folder, "_tim2.xml"));
